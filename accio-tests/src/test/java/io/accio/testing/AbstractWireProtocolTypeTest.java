...
import static io.accio.testing.DataType.dataType;
        ...
        extends AbstractWireProtocolTest
{
    ...
    private WireProtocolTypeTest varcharDataTypeTest()
    {
        return createTypeTest()
                ...
                .addInput(textDataType(), "accio_text")
                .addInput(nameDataType(), "accio_name");
    }
