...
class TestOracle19cDateArithmetic:
    ...
    def test_date_add_day_simple(self):
    ...
    def test_date_add_day_multiple(self):
    ...
    def test_date_sub_day_simple(self):
    ...
    def test_date_sub_day_multiple(self):
    ...
    def test_date_arithmetic_in_where_clause(self):
    ...
    def test_mixed_date_operations(self):
    ...
    def test_date_add_with_column_names(self):
    ...
    def test_date_arithmetic_in_select_expression(self):
    ...
    def test_date_month_arithmetic_edge_case(self):
    ...
    def test_date_year_subtraction_with_multiple_years(self):
