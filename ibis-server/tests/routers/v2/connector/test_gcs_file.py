...
pytestmark = pytest.mark.gcs_file

key_id = os.getenv("GCS_KEY_ID")
secret_key = os.getenv("GCS_SECRET_ACCESS_KEY")
bucket = os.getenv("GCS_BUCKET")
credentials = os.getenv("GCS_CREDENTIALS_BASE64_JSON")

base_url = "/v2/connector/gcs_file"
manifest = {
    "catalog": "my_calalog",
    "schema": "my_schema",
    "models": [
