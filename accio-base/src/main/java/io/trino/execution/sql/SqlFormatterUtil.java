...
public final class SqlFormatterUtil
{
    ...
    private static AccioException formattingFailure(@Nullable Throwable cause, String message, Statement statement, String sql)
    {
        AccioException exception = new AccioException(GENERIC_INTERNAL_ERROR, message, cause);
