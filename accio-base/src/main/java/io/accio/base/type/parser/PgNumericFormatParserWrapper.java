...
package io.accio.base.type.parser;

import io.accio.base.AccioException;
import io.accio.base.type.parser.antlr.v4.PgNumericFormatBaseVisitor;
import io.accio.base.type.parser.antlr.v4.PgNumericFormatLexer;
import io.accio.base.type.parser.antlr.v4.PgNumericFormatParser;
...
public final class PgNumericFormatParserWrapper
{
            ...
            extends PgNumericFormatBaseVisitor<String>
    {
        ...
        {
            throw new AccioException(GENERIC_INTERNAL_ERROR, String.format("we didn't support the pattern %s.", ctx.getText()));
        }
    }
}
