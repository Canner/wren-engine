...
import io.accio.base.type.parser.antlr.v4.PgArrayLexer;
import io.accio.base.type.parser.antlr.v4.PgArrayParser;
...
public class PgArrayParserWrapper
{
            ...
            Function<byte[], Object> convert)
    {
        try {
            ...
            throw new AccioException(GENERIC_INTERNAL_ERROR, "stack overflow while parsing: " + e.getLocalizedMessage());
        }
        catch (IOException e) {
