...
package io.wren.main.sql.bigquery.analyzer;
...
import io.wren.base.sqlrewrite.analyzer.ExpressionTypeAnalyzer;
import io.wren.base.sqlrewrite.analyzer.Scope;
import io.wren.base.sqlrewrite.analyzer.TypeCoercion;
        ...
        implements TypeCoercion
{
    ...
    public BigQueryTypeCoercion(WrenMDL mdl)
    {
