...
public class BigQueryCredentialsSupplier
{
    ...
    private static Credentials createCredentialsFromKey(String key)
    {
        try {
            ...
            throw new WrenException(GENERIC_USER_ERROR, "Failed to create Credentials from key", e);
        }
    }
    ...
    private static Credentials createCredentialsFromFile(String file)
    {
        try {
            ...
            throw new WrenException(GENERIC_USER_ERROR, "Failed to create Credentials from file", e);
        }
    }
