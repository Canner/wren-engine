        ...
        extends PgCatalogTable
{
    ...
    protected Map<String, String> createTableContent()
    {
        return ImmutableMap.<String, String>builder()
                ...
                .put("pronamespace", "${hash}('" + PgCatalogTableUtils.PG_CATALOG + "')")
                .put("proowner", "${hash}('" + PgCatalogTableUtils.DEFAULT_AUTH + "')")
                .put("prolang", "${hash}('" + PgCatalogTableUtils.INTERNAL_LANGUAGE + "')")
                .put("procost", "1")
                .put("prorows", "0")
                .put("provariadic", "0")
                .put("prosupport", "null")
