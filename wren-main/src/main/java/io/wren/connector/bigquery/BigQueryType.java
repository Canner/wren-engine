...
import static io.wren.base.type.PGTypes.toPgRecordArray;
import static io.wren.base.type.RealType.REAL;
import static io.wren.base.type.RecordType.EMPTY_RECORD;
import static io.wren.base.type.SmallIntType.SMALLINT;
import static io.wren.base.type.TinyIntType.TINYINT;
...
public final class BigQueryType
{
    ...
    private static PGType<?> toPGTypeWithoutRepeated(Field field)
    {
        ...
        return Optional.ofNullable(bqTypeToPgTypeMap.get(bigQueryType))
                .orElseThrow(() -> new WrenException(NOT_SUPPORTED, "Unsupported Type: " + bigQueryType));
    }
    ...
    public static StandardSQLTypeName toBqType(PGType<?> pgType)
    {
        ...
        return Optional.ofNullable(pgTypeToBqTypeMap.get(pgType))
                .orElseThrow(() -> new WrenException(NOT_SUPPORTED, "Unsupported Type: " + pgType.typName()));
    }
