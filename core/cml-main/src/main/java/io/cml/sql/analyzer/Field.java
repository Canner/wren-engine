...
public class Field
{
    ...
    public static Field newUnqualified(String name, PGType type)
    {
    ...
    public static Field newUnqualified(Optional<String> name, PGType type)
    {
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
    ...
    public static Field newUnqualified(Optional<String> name, PGType type, Optional<QualifiedObjectName> originTable, Optional<String> originColumn, boolean aliased)
    {
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
    ...
    public static Field newQualified(QualifiedName relationAlias, Optional<String> name, PGType type, boolean hidden, Optional<QualifiedObjectName> originTable, Optional<String> originColumn, boolean aliased)
    {
    ...
    public static Field newQualified(QualifiedName relationAlias, Optional<String> name, PGType type, boolean hidden, Optional<QualifiedObjectName> originTable, Optional<QualifiedObjectName> cannerflowTable, Optional<String> originColumn, boolean aliased)
    {
        requireNonNull(relationAlias, "relationAlias is null");
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
        requireNonNull(originTable, "originTable is null");
        requireNonNull(cannerflowTable, "cannerflowTable is null");

        return new Field(Optional.of(relationAlias), name, type, hidden, originTable, originColumn, aliased);
    }

    public Field(Optional<QualifiedName> relationAlias, Optional<String> name, PGType type, boolean hidden, Optional<QualifiedObjectName> originTable, Optional<String> originColumnName, boolean aliased)
    {
        requireNonNull(relationAlias, "relationAlias is null");
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
