...
import io.cml.type.parser.PgArrayParserWrapper;
...
{
    public static final PGArray CHAR_ARRAY = new PGArray(1002, CHAR);
    ...
    public static final PGArray INT4_ARRAY = new PGArray(1007, INTEGER);
    public static final PGArray OID_ARRAY = new PGArray(1028, OID_INSTANCE);
    ...
    public static final PGArray UUID_ARRAY = new PGArray(2951, UUID);
