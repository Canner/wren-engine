...
import static io.cml.type.PgDatetimeUtils.toPgTimestamp;
import static io.cml.type.PgDatetimeUtils.toTrinoTimestamp;
        ...
        extends PGType
{
    ...
    public Object readBinaryValue(ByteBuf buffer, int valueLength)
    {
        ...
        return toTrinoTimestamp(microSecondsSince2K);
    }
}
