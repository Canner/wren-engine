        ...
        extends QueryBody
{
    ...
    // For CannerflowSqlRewrite
    public Table(Optional<NodeLocation> location, QualifiedName name, QueryPeriod queryPeriod)
    {
        this(location, name, Optional.ofNullable(queryPeriod));
    }
