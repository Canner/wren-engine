...
import io.accio.validation.exception.NotFoundException;
        ...
        extends ValidationRule
{
    ...
    {
        return accioMDL.listRelationships().stream().map(relationship -> validateRelationship(client, relationship, accioMDL.listModels()))
