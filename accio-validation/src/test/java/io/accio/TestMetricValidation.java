...
import io.accio.validation.DuplicateModelNameValidation;
import io.accio.validation.EnumValueValidation;
import io.accio.validation.MetricValidation;
import io.accio.validation.ModelNameValidation;
import io.accio.validation.ModelValidation;
...
public class TestMetricValidation
{
        ...
        sample = AccioMDL.fromManifest(withDefaultCatalogSchema()
                .setModels(List.of(
                        Model.model("Flight",
                                ...
                                List.of(
                                        Column.column("FlightDate", AccioTypes.TIMESTAMP, null, true),
                                        Column.column("UniqueCarrier", "Carrier", null, true),
                                        Column.column("OriginCityName", AccioTypes.VARCHAR, null, true),
                                        Column.column("DestCityName", AccioTypes.VARCHAR, null, false),
    ...
    {
        AccioMDL wrongManifest = AccioMDL.fromManifest(withDefaultCatalogSchema()
                .setModels(List.of(
                        Model.model("Flight",
                                format("SELECT * FROM '%s'", flightCsv),
                                List.of(
                                        Column.column("FlightDate", AccioTypes.TIMESTAMP, null, true),
                                        Column.column("illegal^name", AccioTypes.VARCHAR, null, true),
                                        Column.column("123illegalname", AccioTypes.VARCHAR, null, true),
                                        Column.column("notfound", AccioTypes.VARCHAR, null, true),
                                        Column.column("A", AccioTypes.BIGINT, null, false)))))
                .build());
        ...
        // TODO: actually should be 4 but AccioType mapping issue.
    ...
    {
        AccioMDL invalidModels = AccioMDL.fromManifest(withDefaultCatalogSchema()
                .setModels(List.of(
    ...
    public void testRelationshipValidation()
    {
        ...
        AccioMDL accioMDL = AccioMDL.fromManifest(withDefaultCatalogSchema()
                .setModels(List.of(
                        Model.model(
                                "Book",
                                format("SELECT * FROM '%s'", bookCsv),
                                List.of(
                                        Column.column("name", AccioTypes.VARCHAR, null, false),
                                        Column.column("author", AccioTypes.VARCHAR, "User", false))),
                        Model.model("User",
                                format("SELECT * FROM '%s'", userCsv),
                                List.of(
                                        Column.column("id", AccioTypes.INTEGER, null, false),
                                        Column.column("name", AccioTypes.VARCHAR, null, false),
                                        Column.column("email", AccioTypes.VARCHAR, null, false)))))
        ...
        List<ValidationResult> validationResults = MetricValidation.validate(client, accioMDL, List.of(RelationshipValidation.RELATIONSHIP_VALIDATION));
