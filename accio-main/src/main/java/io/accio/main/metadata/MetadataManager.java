        ...
        implements Metadata
{
    ...
    private synchronized void changeDelegate(AccioConfig.DataSourceType dataSourceType)
    {
    ...
    public void reload()
    {
        AccioConfig.DataSourceType newDataSourceType = configManager.getConfig(AccioConfig.class).getDataSourceType();
