...
import io.wren.validation.exception.NotFoundException;
        ...
        extends ValidationRule
{
    ...
    {
        return wrenMDL.listRelationships().stream().map(relationship -> validateRelationship(client, relationship, wrenMDL.listModels()))
