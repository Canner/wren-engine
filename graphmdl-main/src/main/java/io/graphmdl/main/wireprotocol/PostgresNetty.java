...
import io.graphmdl.main.netty.ChannelBootstrapFactory;
        ...
        bootstrap.childHandler(new ChannelInitializer()
        {
            ...
            protected void initChannel(Channel ch)
            {
                ...
                WireProtocolSession wireProtocolSession =
                        new WireProtocolSession(regObjectFactory, connector, sqlConverter, graphMDLMetastore, preAggregationManager, preAggregationTableMapping);
